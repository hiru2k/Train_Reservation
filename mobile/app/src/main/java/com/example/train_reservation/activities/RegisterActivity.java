 ...
 * Description: Contains the functionality of traveler registration with calling the API
            ...
            public void onClick(View v) {
                if (isNetworkAvailable()) {
                    ...
                    if (UserInputValidation.validateAllFields(username, nic, email, password, phone)) {
                        ...
                        call.enqueue(new Callback<Void>() {
                            ...
                            public void onResponse(Call<Void> call, Response<Void> response) {
                                ...
                                if (response.code() == 401) {
                                    Toast.makeText(RegisterActivity.this, "User is already exist in same NIC",
                                            Toast.LENGTH_SHORT).show();
                                }
                        ...
                        Toast.makeText(RegisterActivity.this, "Invalid input. Please check the fields.",
                                Toast.LENGTH_SHORT).show();
                    }
                } else {

                    Toast.makeText(RegisterActivity.this, "No Internet connection. Please check your network settings.",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
