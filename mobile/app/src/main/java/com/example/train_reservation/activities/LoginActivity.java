...
public class LoginActivity extends AppCompatActivity {
    ...
    //Login CANNOT done without internet because , if the user register through the web, the deatails are stored only in mongodb
                               ...
                               if(user.status.equals("Active")) { //not working =="Active"
                                   ...
                                   builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                       ...
                                       public void onClick(DialogInterface dialog, int which) {
                                           ...
                                           UpdateProfileAPIInterface updateProfileAPIInterface = retrofit.create(UpdateProfileAPIInterface.class);

                                           user.status = "Pending";

                                           // Call API endpoint
                                           Call<Void> call = updateProfileAPIInterface.updateUserProfile(user.nic,user);
                                           ...
                                           call.enqueue(new Callback<Void>() {
                                               ...
                                               public void onResponse(Call<Void> call, Response<Void> response) {
                                                   if (response.isSuccessful()) {
                                                       ...
                                                       Toast.makeText(LoginActivity.this, "Request is recored, wait until the activation!,", Toast.LENGTH_SHORT).show();
    ...
    private void saveTokenToSharedPreferences(String token,User user) {
      ...
      //save token with key "token"
        ...
        // Save the user JSON string with a unique key (in this case, "user")
