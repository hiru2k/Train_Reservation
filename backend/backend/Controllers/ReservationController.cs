...
namespace backend.Controllers
{
    ...
    public class ReservationController : ControllerBase
    {
        ...
        [HttpGet("getReservationsByTrainName/{trainName}")]
        public async Task<List<Reservation>> GetByTrainName(string trainName)
        {
            return await _reservationServices.GetReservationsByTrainNameAsync(trainName);
        }
