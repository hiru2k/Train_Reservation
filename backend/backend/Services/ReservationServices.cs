...

{
    public class ReservationServices
    {
        ...
        public async Task<List<Reservation>> GetReservationsByTrainNameAsync(string trainName)
        {
            return await _reservationCollection.Find(r => r.TrainName == trainName).ToListAsync();
        }
